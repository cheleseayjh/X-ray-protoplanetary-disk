...
module krome_commons
  ...
  integer,parameter::idx_C2H3Nj=279
  ...
  integer,parameter::idx_C2H2Nj=330
  ...
  real*8::user_Av,user_crate,user_gas_dust_ratio
  !$omp threadprivate(user_Av,user_crate,user_gas_dust_ratio)
